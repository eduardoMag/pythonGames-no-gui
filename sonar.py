...
def showInstructions():
    ...
    print("For example, here is a teasure chest (the c) located a distance of 2 away from the sonar device (the d):\n"
          ...
          "Sonar devices can detect tresure chests up to a distance of 9. if all chest are out of range, the point "
          "will be marked with 0.\n "
          "If a device is directly dropped on a tresure chest, the have discovered the location of the chest, "
          "and it will be collected.\n "
          "the sonar device will remain there. When you collect a chest, all sonar devices will update to locate the "
          "next closest sunken treasure chest.\n "
          "Press enter to continue...")
    input()
    print()
